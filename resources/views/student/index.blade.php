            ...
            <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-gray-900 border-b border-gray-700">
                    <div class="flex justify-end mb-4">
                        <a href="{{ route('students.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded border">
                            Add Student
                        </a>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b border-gray-700">
                                        <div class="flex space-x-2">
                                            ...
                                            <a href="{{ route('students.show', $student) }}" class="border mr-1 bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-1 px-3 rounded">View</a>
